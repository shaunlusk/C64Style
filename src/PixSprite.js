...
* @constructor
* @param {C64Style.C64Screen} screenContext The parent screen
...
*   from Sprite:
*   <ul>
*     <li>frames - Array - Optional. An array of C64Style.PixSpriteFrame's. Default: empty array
...
C64Style.PixSprite.prototype = new SL.Sprite();
...
C64Style.PixSpriteFrame.prototype = new SL.AnimationFrame();
