...
*/
C64Style.PixRenderer.prototype.renderPixPath = function(context, x, y, pixPath, palette, pixPathScaleX, pixPathScaleY, isHorizontallyFlipped, isVerticallyFlipped, rotation) {
  ...
  if (flipHorizontally || flipVertically || rotation) {
    this.renderPixPathWithTranslation();
  } else {
    switch (pixPath.type) {
...
SL.ImageRenderer.prototype.renderPixPathWithTranslation = function(context, x, y, pixPath, palette, pixPathScaleX, pixPathScaleY, isHorizontallyFlipped, isVerticallyFlipped, rotation) {
