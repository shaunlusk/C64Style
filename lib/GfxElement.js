...
C64Style.GfxElement.prototype.clear = function(time, diff) {
  // if (debug) {
  //   console.log(Math.floor(performance.now()) + " clearing: " + this.getId() +": " + this.getLastX() + ":" + this.getWidth() + ", " + this.getLastY() + ":" + this.getHeight());
  //   console.log(Math.floor(performance.now()) + " clearing: " + this.getId() + ": collision? " + this.hasCollision() + "; hadCollision? "+ this._hadCollisionPreviousFrame);
  // }

  // this.getCanvasContext().clearRect(this.getLastX() * this.getScaleX(), this.getLastY() * this.getScaleY(), this.getWidth() * this.getScaleX(), this.getHeight() * this.getScaleY());
...
C64Style.GfxElement.prototype.render = function(time, diff) {
  // if (debug) {
  //   console.log(Math.floor(performance.now()) + " rendering " + this.getId() + ": collision? " + this.hasCollision() + "; hadCollision? "+ this._hadCollisionPreviousFrame);
  // }
...
C64Style.GfxElement.prototype.collidesWith = function(element) {
  ...
  var result = thisX < thatX + thatWidth &&
    ...
    //     " collision:((" +
    //     thisX + "," + thisY +"),(" +
    //     (thisX + thisWidth) + "," + (thisY + thisHeight) + ")) - ((" +
    //     thatX + "," + thatY + "),(" +
    //     (thatX + thatWidth) + "," + (thatY + thatHeight) + "))");
    //   debug = true;
    // }
    // return true;
  return result;
...
// C64Style.GfxElement.prototype.getCollisionBoxX = function() {return this.getX() * this.getScaleX();};
// C64Style.GfxElement.prototype.getCollisionBoxY = function() {return this.getY() * this.getScaleY();};
// C64Style.GfxElement.prototype.getCollisionBoxWidth = function() {return this.getWidth() * this.getScaleX();};
// C64Style.GfxElement.prototype.getCollisionBoxHeight = function() {return this.getHeight() * this.getScaleY();};
