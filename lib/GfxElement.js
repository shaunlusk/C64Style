...
C64Style.GfxElement.prototype.clear = function() {
  // console.log("clearing: " + this.getLastX() + ":" + this.getWidth() + ", " + this.getLastY() + ":" + this.getHeight());
  this.getCanvasContext().clearRect(this.getLastX(), this.getLastY(), this.getWidth(), this.getHeight());
};
...
C64Style.GfxElement.prototype.getCollisionBoxX = function() {return this.getX();};
C64Style.GfxElement.prototype.getCollisionBoxY = function() {return this.getY();};
C64Style.GfxElement.prototype.getCollisionBoxWidth = function() {return this.getWidth();};
C64Style.GfxElement.prototype.getCollisionBoxHeight = function() {return this.getHeight();};
