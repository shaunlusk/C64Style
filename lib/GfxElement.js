...
C64Style.GfxElement.prototype.clear = function() {
  // if (debug) {
  //   console.log("clearing: " + this.getId() +": " + this.getLastX() + ":" + this.getWidth() + ", " + this.getLastY() + ":" + this.getHeight());
  //   console.log("clearing: " + this.getId() + ": collision? " + this.hasCollision() + "; hadCollision? "+ this._hadCollisionPreviousFrame);
  // }
