...
C64Style.CharacterRenderer.prototype.render = function(character, context, x, y, color, backgroundColor) {
  if (backgroundColor) {
    context.fillStyle = backgroundColor;
    context.fillRect(x, y, C64Style.CELLWIDTH * this._scaleX, C64Style.CELLHEIGHT * this._scaleY);
  } else {
    context.clearRect(x, y, C64Style.CELLWIDTH * this._scaleX, C64Style.CELLHEIGHT * this._scaleY);
  }
