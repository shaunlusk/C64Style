...
C64Style.C64Screen.prototype.handleMouseEvent = function(e) {
  ...
  var row = this._xToColumnFromMouseEvent(x);
  var col = this._yToRowFromMouseEvent(y);
...
C64Style.C64Screen.prototype.xToColumn = function(x) {
  return Math.floor(x / (C64Style.CELLWIDTH * this._scaleX) - this.getViewOriginX());
};
...
C64Style.C64Screen.prototype.yToRow = function(y) {
  return Math.floor(y / (C64Style.CELLHEIGHT * this._scaleY) - this.getViewOriginY());
};
