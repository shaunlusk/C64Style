...
*/
C64Style.C64Screen.prototype.getColFromMouseEvent = function(e) {
...
* @param {Event} e Mouse Event
*/
C64Style.C64Screen.prototype.getRowFromMouseEvent = function(e) {
  return Math.floor(this.getYFromMouseEvent(e) / (C64Style.CELLHEIGHT * this._scaleY));
};

C64Style.C64Screen.prototype.columnToX = function(col) {
  var x = col * this.getScaleX() * C64Style.CELLWIDTH;
  return x;
};
C64Style.C64Screen.prototype.xToColumn = function(x) {
  var col = x / (this.getScaleX() * C64Style.CELLWIDTH);
  return col;
};

C64Style.C64Screen.prototype.rowToY = function(row) {
  var y = row * this.getScaleY() * C64Style.CELLHEIGHT;
  return y;
};
C64Style.C64Screen.prototype.yToRow = function(y) {
  var row = y / (this.getScaleY() * C64Style.CELLHEIGHT);
  return row;
};
