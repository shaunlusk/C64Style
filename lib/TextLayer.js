...
C64Style.TextLayer = function(screenContext, canvas, props) {
  ...
  this._characterRenderer = props.characterRenderer || new C64Style.CharacterRenderer(this._scaleX, this._scaleY);
  this._pendingTextStrings = new RArray();
  this._scaledCellWidth = C64Style.CELLWIDTH * this._scaleX;
  this._scaledCellHeight = C64Style.CELLHEIGHT * this._scaleY;
};
