...
* Generally, the use of C64Style.C64Screen.createLayer("TextLayer") is preferred over creating layer by hand.
* @constructor
* @param {C64Style.C64Screen} screenContext The parent screen for this layer.
...
C64Style.TextLayer.prototype = new SL.Layer();
...
*/
C64Style.TextLayer.prototype.clearLayer = function() {
  SL.Layer.prototype.clearLayer.call(this);
  this._pendingTextStrings = [];
};
